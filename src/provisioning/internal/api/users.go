...
func (h *Handler) GetUsers(c *gin.Context) {
	...
	if err != nil {
		h.Logger.WithContext(c).Error("failed to fetch users from database")
...
func (h *Handler) CreateUser(c *gin.Context) {
	...
	if err != nil {
		h.Logger.WithContext(c).Warn("invalid payload for new user")
...
func (h *Handler) GetUserById(c *gin.Context) {
	...
	if err != nil {
		h.Logger.WithContext(c).Warn("failed to extract user id from request")
	...
	if err != nil {
		h.Logger.WithContext(c).Warn("failed to retrieve user from database")
...
func (h *Handler) UpdateUserById(c *gin.Context) {
	...
	if err != nil {
		h.Logger.WithContext(c).Error("user returned from database does not match expected schema")
		h.respondError(c, http.StatusInternalServerError, "failed to retrieve user", err.Error())
		return
	}
	...
	if err != nil {
		h.Logger.WithContext(c).Warn("failed to update user in database")
...
func (h *Handler) DeleteUserById(c *gin.Context) {
	...
	if err != nil {
		h.Logger.WithContext(c).Warn("failed to delete user from database")
...
func (h *Handler) ServersOfUser(c *gin.Context) {
	...
	if err != nil {
		h.Logger.WithContext(c).Warn("failed to fetch servers for given user")
